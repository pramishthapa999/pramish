...
if (isset($_POST['submit'])) {
    if (!empty($_FILES['image']['name'])) {
        ...
        $query = "INSERT INTO portfolio2 (file) VALUES ('$file_name')";
...
<body>
    <header>
        <h1>Wildlife - Portfolio2 Gallery</h1>
    </header>
    ...
    <div class="image-gallery">
        ...
        ?>
                <div class="image-item">
                    <img src="portfolio2/<?php echo $row['file']; ?>" alt="portfolio2 Image">
                    <div class="actions">
                        <a href="update2.php?id=<?php echo $row['id']; ?>">
                            <button>Update</button>
                        </a>
                        <a href="delete2.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this image?');">
